        ...
        req.logIn(user, options, function(err) {
          ...
          function complete() {
            ...
            if (options.successRedirect) {
              console.log(`PASSPORT SUCCESS REDIRECT to ${options.successRedirect} with session`);
          ...
          console.log("TIME TO PASSPORT SUCCESS");
          if (options.authInfo !== false) {
            passport.transformAuthInfo(info, req, function(err, tinfo) {
              if (err) { return next(err); }
              req.authInfo = tinfo;
              console.log("PASSPORT NO REDIRECTION SUCCESS COMP "); console.log(req.session);
              complete();
            });
          } else {
            console.log("PASSPORT NO REDIRECTION SUCCESS"); console.log(req.session);
            complete();
          }
        });
      };
